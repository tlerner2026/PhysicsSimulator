...
def FoilTest():
    ...
    # Define the data directory path relative to the current script's location
    data_dir = os.path.dirname(__file__)

    # Use os.path.join to correctly join the data path
    sail = foil(os.path.join(data_dir, "data", "mainSailCoeffs.cvs"), 0.128, 1)
    ...
    hull = foil(os.path.join(data_dir, "data", "xf-naca001034-il-1000000-Ex.csv"), 1, 0.5) # MARKED
...
def BoatTest():
    ...
    hull = foil(os.path.join(data_dir, "data", "xf-naca001034-il-1000000-Ex.csv"), 1, 0.5) # MARKED
    sail = foil(os.path.join(data_dir, "data", "mainSailCoeffs.cvs"), 0.128, 1) # MARKED
